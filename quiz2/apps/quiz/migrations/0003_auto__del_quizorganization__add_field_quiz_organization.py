...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Quiz.organization'
        db.add_column(u'quiz_quiz', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quiz.Organization'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Quiz.organization'
        db.delete_column(u'quiz_quiz', 'organization_id')
    ...
    models = {
        ...
        u'quiz.quiz': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['quiz.Organization']", 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
