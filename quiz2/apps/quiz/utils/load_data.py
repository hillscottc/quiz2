...
q = Question.objects.create(text="How many planets are in our solar system?", questionset=qs)
...
q = Question.objects.create(text="What is the fourth planet from the sun?", questionset=qs)
...
q = Question.objects.create(text="How many sides on a triangle?", questionset=qs)
...
q = Question.objects.create(text="What is the name of the first US president?", questionset=qs)
...
q = Question.objects.create(text="What is the name of the official national anthem of the USA?", questionset=qs)
...
q = Question.objects.create(text="What is the capital city of Afghanistan?", questionset=qs)
...
q = Question.objects.create(text="Which two colours are on the flag of Poland?", questionset=qs)
...
q = Question.objects.create(text="How many US states begin with the letter 'P'", questionset=qs)
...
q = Question.objects.create(text="Paraguay has borders with Brazil, Bolivia and which other country?", questionset=qs)
...
q = Question.objects.create(text="In which country is Mount Everest?", questionset=qs)
...
q = Question.objects.create(text="What is the national currency of Egypt?", questionset=qs)
